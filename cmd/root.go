...
import (
	...
	"github.com/gkwa/amazoniantexas/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.amazoniantexas.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".amazoniantexas")
	}
